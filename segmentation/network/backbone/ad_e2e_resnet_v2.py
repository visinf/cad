...
__all__ = ['ad_e2e_v2_resnet18', 'ad_e2e_v2_resnet34', 'ad_e2e_v2_resnet50', 'ad_e2e_v2_resnet101',
           'ad_e2e_v2_resnet152']
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        features = batch_graph2img(x, downsampling_mask, 2)
...
def _resnet(arch, block, ap_block, layers, pretrained, progress, **kwargs):
    model = ResNet(block, ap_block, layers, **kwargs)
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls[arch],
                                              progress=progress)
        state_dict = imagenet_ckpt2ap_ckpt(state_dict, 8)
        model.load_state_dict(state_dict, strict=False)
    return model


def ad_e2e_v2_resnet18(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet('resnet18', BasicBlock, BatchAPBottleneck, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)


def ad_e2e_v2_resnet34(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet34', BasicBlock, BatchAPBottleneck, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)


def ad_e2e_v2_resnet50(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50', Bottleneck, BatchAPBottleneck, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)


def ad_e2e_v2_resnet101(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet101', Bottleneck, BatchAPBottleneck, [3, 4, 23, 3], pretrained, progress,
                   **kwargs)


def ad_e2e_v2_resnet152(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet152', Bottleneck, BatchAPBottleneck, [3, 8, 36, 3], pretrained, progress,
                   **kwargs)
