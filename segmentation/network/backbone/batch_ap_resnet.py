...
__all__ = ['BatchAPResNet', 'batch_ap_resnet18', 'batch_ap_resnet34', 'batch_ap_resnet50', 'batch_ap_resnet101',
           'batch_ap_resnet152']
...
def ap_conv3x3(in_planes, out_planes, stride=1, dilation=1, number_pools=0):
    """3x3 convolution with padding"""
    return BatchGraphConv2d(in_planes, out_planes, kernel_size=3, dilation = 1,number_pools=number_pools, padding_mode='zeros', bias=False)
...
class BatchAPBottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, number_pools=0, downsample=None, norm_layer=None):
        ...
        self.stride_down = BatchIrregularDownsample2d(number_downsample=number_pools) # stride of two equals taking every second 
        self.bn2 = norm_layer(width)
...
class BatchAPDownsample(nn.Module):
    expansion = 4

    def __init__(self, inplanes, planes, expansion, number_pools=0, norm_layer=None):
        super(BatchAPDownsample, self).__init__()
        
        self.conv1 = ap_conv1x1(inplanes, planes * expansion)
        self.down = BatchIrregularDownsample2d(number_downsample=number_pools) # stride of two equals taking every second 
    ...
    def _make_ap_layer(self, block, planes, blocks, stride=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            ...
            if stride == 1:
                ...
                downsample = BatchAPDownsample(self.inplanes, planes, block.expansion, self.number_pool, norm_layer)
            else:
...
def _batch_ap_resnet(arch, block, ap_block, layers, pretrained, progress, **kwargs):
    model = BatchAPResNet(block, ap_block, layers, **kwargs)
    if pretrained:
...
def batch_ap_resnet18(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _batch_ap_resnet('resnet18', BasicBlock, BatchAPBottleneck, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)


def batch_ap_resnet34(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _batch_ap_resnet('resnet34', BasicBlock, BatchAPBottleneck, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)


def batch_ap_resnet50(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _batch_ap_resnet('resnet50', Bottleneck, BatchAPBottleneck, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)


def batch_ap_resnet101(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _batch_ap_resnet('resnet101', Bottleneck, BatchAPBottleneck, [3, 4, 23, 3], pretrained, progress,
                   **kwargs)


def batch_ap_resnet152(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _batch_ap_resnet('resnet152', Bottleneck, BatchAPBottleneck, [3, 8, 36, 3], pretrained, progress,
                   **kwargs)
